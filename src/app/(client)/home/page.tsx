          ...
          <motion.div custom={3} variants={fadeUp} initial="hidden" animate="show">
            ...
            >
              <div className="relative w-10 h-10 shrink-0">
                <div className="w-10 h-10 rounded-full bg-tornoo-green/20 border border-tornoo-green/40 flex items-center justify-center">
                  <WaitDot level="low" size={9} />
                </div>
                <span className="absolute inset-0 rounded-full border-2 border-tornoo-green/60 animate-ping" />
              </div>
